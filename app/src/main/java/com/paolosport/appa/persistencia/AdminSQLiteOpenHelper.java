...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    static final String TEST_LOCAL = "INSERT INTO local " +
            "( id,          nombre ) VALUES " +
            "( '1',           'Pontevedra Local 101'     )," +
            "( '2',           'Andes Local 102'          )," +
            "( '3',           'Andes Local 204'          )," +
            "( '4',           'Unicentro Local 108'      )," +
            "( '5',           'Galerias Local 202'       )";
    ...
    static final String TEST_MARCA = "INSERT INTO marca " +
            "( id,          nombre,           logo ) VALUES " +
            "( '1',         'Mike',           'mike.jpg'     )," +
            "( '2',         'Pumba',          'pumba.jpg'    )," +
            "( '3',         'Adibas',         'adibas.jpg'   )," +
            "( '4',         'Converse',       'converse.jpg' )," +
            "( '5',         'Bubble Gummers', 'bubble.jpg'   )";
